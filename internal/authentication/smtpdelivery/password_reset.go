...
func (d *Delivery) DeliverPasswordResetCode(ctx context.Context, destination, code string, expiresAt time.Time) error {
	...
	message := fmt.Sprintf(
		"From: %s\r\nTo: %s\r\nSubject: BeeBox password reset\r\nContent-Type: text/plain; charset=UTF-8\r\n\r\nYour BeeBox password reset code is %s. It expires at %s.\r\n",
