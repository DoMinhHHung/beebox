...
func Generate() (Generated, error) {
	...
	if err != nil {
		return Generated{}, ErrGeneration
	}
...
func Parse(g Generated) error {
	privateKey, err := base64.RawURLEncoding.DecodeString(g.PrivateKey)
	if err != nil || len(privateKey) != ed25519.PrivateKeySize {
		return ErrGeneration
	}
	publicKey, err := base64.RawURLEncoding.DecodeString(g.PublicKey)
	...
	if !derived.Equal(ed25519.PublicKey(publicKey)) {
		return ErrGeneration
	}
	return nil
}
