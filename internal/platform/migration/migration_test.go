...
func TestEmbeddedSourcesAreValidAndOrdered(t *testing.T) {
	...
	want := []string{
		...
		"00022_session_self_service.sql",
		"00023_identity_profile_self_service.sql",
		"00024_email_signin_links.sql",
		"00025_organizations.sql",
		"00026_organization_memberships.sql",
		"00027_organization_authorization.sql",
	}
